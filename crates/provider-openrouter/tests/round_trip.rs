...
//!
//! These never touch real OpenRouter: a `wiremock` server stands in for
...
async fn happy_path_round_trips_with_usage_and_cost() {
    ...
    Mock::given(method("POST"))
        ...
        // Auth + the recommended OpenRouter attribution headers go out.
        .and(header("authorization", "Bearer sk-test"))
        .and(header("http-referer", "https://github.com/ArdurAI/ardur-agent"))
